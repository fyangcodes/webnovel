# Generated by Django 5.2.2 on 2025-06-27 08:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["book", "status"], name="books_bookf_book_id_80578a_idx"
                    ),
                    models.Index(
                        fields=["status", "processing_progress"],
                        name="books_bookf_status_68d473_idx",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["content_type", "original_object_id"],
                        name="books_chang_content_1d06b2_idx",
                    ),
                    models.Index(
                        fields=["content_type", "changed_object_id"],
                        name="books_chang_content_8f67c2_idx",
                    ),
                    models.Index(
                        fields=["user", "change_type"],
                        name="books_chang_user_id_71d26f_idx",
                    ),
                    models.Index(
                        fields=["created_at"], name="books_chang_created_2980be_idx"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("chapter_number", books.fields.AutoIncrementingPositiveIntegerField()),
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["book", "status"], name="books_chapt_book_id_8e54c4_idx"
                    ),
                    models.Index(
                        fields=["language", "status"],
                        name="books_chapt_languag_9a8802_idx",
                    ),
                    models.Index(
                        fields=["active_at", "status"],
                        name="books_chapt_active__9ffada_idx",
                    ),
                ],
        ...
        migrations.AddIndex(
            model_name="book",
            index=models.Index(
                fields=["language", "status"], name="books_book_languag_2c24ff_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="book",
            index=models.Index(
                fields=["author", "status"], name="books_book_author__6f8956_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="author",
            index=models.Index(
                fields=["canonical_name"], name="books_autho_canonic_c14ee0_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="author",
            index=models.Index(
                fields=["language"], name="books_autho_languag_52874d_idx"
            ),
        ),
    ]
