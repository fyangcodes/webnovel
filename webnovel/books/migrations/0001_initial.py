    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('D', 'Draft'), ('O', 'Ongoing'), ('C', 'Completed'), ('A', 'Archived')], default='D', help_text='Book status (e.g., draft, ongoing, completed, archived)', max_length=20)),
                ...
                ('master', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='books', to='books.bookmaster')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('canonical_name', models.CharField(max_length=255)),
                ('book_master', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='chapter_masters', to='books.bookmaster')),
            ],
            options={
                'ordering': ['canonical_name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paragraph_style', models.CharField(choices=[('S', 'Single Newline'), ('D', 'Double Newline'), ('A', 'Auto Detect')], default='A', help_text='How to parse paragraphs from raw content', max_length=20)),
                ('status', models.CharField(choices=[('D', 'Draft'), ('T', 'Translating'), ('S', 'Scheduled'), ('P', 'Published'), ('A', 'Archived')], default='D', help_text='Chapter status', max_length=20)),
                ('active_at', models.DateTimeField(blank=True, help_text='When this chapter should become active/published', null=True)),
                ('rating', models.CharField(choices=[('E', 'Everyone'), ('T', 'Teen (13+)'), ('M', 'Mature (16+)'), ('A', 'Adult (18+)')], default='E', max_length=20)),
                ...
                ('master', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='chapters', to='books.chaptermaster')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('media_type', models.CharField(choices=[('I', 'Image'), ('A', 'Audio'), ('V', 'Video'), ('D', 'Document'), ('O', 'Other')], default='I', help_text='Type of media content', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('W', 'Waiting'), ('P', 'Processing'), ('C', 'Completed'), ('F', 'Failed')], default='W', help_text='Processing status of the file', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('change_type', models.CharField(choices=[('T', 'Translation'), ('E', 'Edit/Correction'), ('O', 'Other')], default='E', max_length=20)),
        ...
        migrations.AddIndex(
            model_name='chaptermaster',
            index=models.Index(fields=['book_master'], name='books_chapt_book_ma_743076_idx'),
        ),
        migrations.AddIndex(
