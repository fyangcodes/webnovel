    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['book', 'chapter_number'], name='books_chapt_book_id_de56cf_idx'), models.Index(fields=['book', 'status'], name='books_chapt_book_id_8e54c4_idx'), models.Index(fields=['language', 'status'], name='books_chapt_languag_9a8802_idx'), models.Index(fields=['active_at', 'status'], name='books_chapt_active__9ffada_idx')],
