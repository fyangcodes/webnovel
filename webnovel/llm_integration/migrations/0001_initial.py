    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="llm_integration.llmprovider",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["provider", "operation", "status"],
                        name="llm_integra_provide_b5e63b_idx",
                    ),
                    models.Index(
                        fields=["created_at"], name="llm_integra_created_a46c86_idx"
                    ),
                    models.Index(
                        fields=["book", "chapter"],
