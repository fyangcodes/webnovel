...
from .forms import (
    UserProfileForm, BookCollaboratorForm, TranslationAssignmentForm,
    RoleAssignmentForm, UserSearchForm, TranslationAssignmentFilterForm
)
from .mixins import (
    BookPermissionMixin, TranslationPermissionMixin, EditorPermissionMixin,
    AdminPermissionMixin, WriterPermissionMixin
)
from .permissions import (
    get_user_permissions, get_books_user_can_access,
    get_translation_assignments_for_user, assign_translation_task
)
...
class TranslationAssignmentListView(TranslationPermissionMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['filter_form'] = TranslationAssignmentFilterForm(
