...
def can_user_translate_chapter(user, chapter, target_language):
    ...
    existing_translation = chapter.translations.filter(language=target_language).exists()
...
def assign_translation_task(user, chapter, target_language, assigned_by=None, due_date=None):
    """
